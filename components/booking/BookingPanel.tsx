...
export function BookingPanel({
  ...
  return (
    <>
      ...
      {/* Panel */}
      <div className="fixed inset-y-0 right-0 z-50 flex w-full max-w-lg" onClick={(e) => e.stopPropagation()}>
        <div className="ml-auto flex h-full w-full flex-col overflow-hidden bg-white shadow-2xl shadow-slate-900/20">
          {/* Header with car info */}
          <div className="relative shrink-0 overflow-hidden bg-gradient-to-r from-navy via-navy-light to-navy-muted px-6 py-5">
            ...
            {submitted ? (
              <>
                <div className="rounded-2xl bg-emerald-50 p-6 text-center">
                  <span className="mx-auto grid size-13 place-items-center rounded-full bg-emerald-100 text-emerald-600">
